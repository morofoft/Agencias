            ...
            <div class="relative pl-10">
                ...
                <div class="bg-white rounded-[1.5rem] p-5 shadow-sm border border-slate-100">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <h4 class="font-black text-slate-800 text-sm leading-none">${a.idreal}</h4>
...
/* =====================
   Agregar agencia aquí
===================== */

/* =====================
   Agregar agencia con tu lógica GPS
===================== */
btnAdd?.addEventListener('click', async () => {
    // 1. Mostramos feedback de carga mientras obtenemos GPS
    Swal.fire({
    ...
    navigator.geolocation.getCurrentPosition(async pos => {
      ...
      // 2. Formulario moderno con tus campos (Código, Zona, Dirección)
      ...
      // 3. Uso de tu función importada de agencies.actions.js
      try {
        ...
        // 4. Recargar la vista para que aparezca la nueva agencia
        await loadNearby();
...
window.registrarVisita = async function(id) {
    ...
    if (formValues) {
      // Actualizamos el objeto de la agencia
      const updatedAgency = {
        ...agency,
      ...
      loadNearby(); // Recargamos para ver los cambios
    }
  };
